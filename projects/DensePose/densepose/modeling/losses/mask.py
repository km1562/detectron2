...
class DataForMaskLoss:
    """
    Contains mask GT and estimated datas for proposals from multiple images:
    """

    # tensor of size (K, H, W) containing GT ori_annotation_file_list
...
def extract_data_for_mask_loss_from_matches(
    ...
    Return:
        ...
        masks_gt: tensor(K, S, S) of int64 - ori_annotation_file_list
    """
...
class MaskLoss:
    """
    Mask loss as cross-entropy for raw unnormalized scores given ground truth ori_annotation_file_list.
    Mask ground truth ori_annotation_file_list are defined for the whole image and not only the
    ...
    def __call__(
        ...
        scores given ground truth ori_annotation_file_list.
        ...
        Return:
            ...
            ground truth ori_annotation_file_list from masks
        """
